...
class InstrumentExperience extends Component {
    ...
    return this.state.instruments.map((instrument, index) => (
      <div key={index}>
        <Form.Group widths='equal'>
          ...
          <Button className="instrument-exp" index={index} onClick={this.deletePair}>Delete</Button>
        </Form.Group>
      </div>
    ))
  }
  ...
  render() { 
    ...
    return (
      <div>
        {this.createUI()}
        <Button className="instrument-exp" onClick={this.onClick}>Add Instrument</Button>
